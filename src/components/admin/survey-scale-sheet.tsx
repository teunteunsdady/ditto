...
export function SurveyScaleSheet({ clientId, testSlug, questions }: SurveyScaleSheetProps) {
  ...
  const answeredCount = useMemo(
    () => questions.filter((_, index) => answers[index + 1] != null).length,
    [answers, questions],
  );
